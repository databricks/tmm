...
4. **[Spark Declarative Pipeline with Genie Code](docs/04-pipeline.md)** — ingest and clean the data into per-region gold tables.
5. **[Databricks App with Genie Code](docs/05-app.md)** — visualize APAC flight routes on a zoomable map.
