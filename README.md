...
- **[DSDE-Genie-Workshop](DSDE-Genie-Workshop/)** — Hands-on tutorial (runs on **Databricks Free Edition**) getting data scientists and engineers started with **Genie** on 696M real **OpenSky Network** avionics records: **Marketplace** → **Genie Agents** (EDA, explore & visualize) → **Genie Code** for a **Spark Declarative Pipeline** and a **Databricks App** → **OpenSharing** to a local OSS client.
