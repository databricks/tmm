...
Their expertise and assistance have been invaluable in the development of this project.Here's the revised README.md with typos and style issues fixed, and an added Acknowledgements section:
...
4. Run one of the data ingestion notebooks to start streaming data from GCN.![DLT][]

5. If the data ingestion works, use the provided code to configure a triggered DLT pipeline using serverless compute.
   * Make sure to reference the correct secrets from the pipeline code.![DLT][]
...
8. Explore the data by asking questions about:
   ...
   * The total number of events
   * The distribution of merit values
   * Plot the DEC and RA coordinates (in the DAIS session)![DLT][]
