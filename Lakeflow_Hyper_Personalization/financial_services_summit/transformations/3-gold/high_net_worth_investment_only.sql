-- Our data pipeline automatically spots Sarah as a "High Net Worth" prospect who is investing but doesn't have a private banking relationship with us. The system calculates she could generate ~$18,000 in annual banking revenue.
CREATE MATERIALIZED VIEW finance_summit.pipeline.high_value_investment_prospects AS
SELECT
  nw.customer_id,
  nw.total_net_worth,
  CASE
  ...
  c.campaign_name
FROM
  finance_summit.pipeline.customer_net_worth nw
