...
dbutils.widgets.combobox('user_id','DUMMY' ,['DUMMY'], label= 'user_id')
...
dbutils.widgets.dropdown('num_recs', '1000', ['1000','5000'], '#rec/write')
dbutils.widgets.combobox('batch_count', '200', ['0', '100', '200', '500'], '#writes')

# COMMAND ----------

path = '/demos/dlt/'+dbutils.widgets.get('user_id')
...
if reset_all_data and output_path.startswith('/demos/dlt/'+user_id):
...
#def base_rate():
#  b = random.choices(
#              population=["ZERO", "UKBRBASE", "FDTR", "None"],
#              weights=[0.5, 0.1, 0.3, 0.01])[0]
#  return b
