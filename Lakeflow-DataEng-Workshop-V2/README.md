...
- The [`misc/setup_workshop.py`](./misc/setup_workshop.py) notebook has been run once to provision shared assets (landing volume + seeded JSON fraud markers; Zerobus target table, service principal, UC grants, and config table).
