...
- **Lab 3 — Zerobus Ingest with IoT data** *(live instructor demo; attendees may follow along).* Direct ingest into Delta tables via the Zerobus REST API, with scoped OAuth and a UC config table for shared credentials. Reference file in [`lab3/`](./lab3/).
